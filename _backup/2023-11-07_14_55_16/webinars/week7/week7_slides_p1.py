...
res = ser.loc[label_seq] # makes it easier to read
...
# <example>
res = ser.iloc[start:end] # --> results in an empty series
# </example>
printit(res, f"ser.iloc[{start}:{end}]")
...
# ----------------------------------------------------------------------------
# ----------------------------------------------------------------------------
#   Selecting observations from data frames
# ----------------------------------------------------------------------------
# ----------------------------------------------------------------------------
# ----------------------------------------------------------------------------
# ----------------------------------------------------------------------------
...
# printing all the values in column 'close' (series)
res = df.loc[ : , 'close']
printit(res)

# printing all the values in column 'close' (dataframe)
res = df.loc[ : , ['close']]
printit(res)

# printing all the values in row '2020-01-02' (series)
res = df.loc['2020-01-02', : ]
printit(res)

# printing all the values in row '2020-01-02'
res = df.loc['2020-01-02', : ]
printit(res)
...
res1 = df.loc['2020-01-02', :]
res2 = df.loc['2020-01-02']
...
# Suppose next, we want the result to be a series with index equal to ['close',
